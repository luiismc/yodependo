...
import { View, StyleSheet, Platform, TouchableHighlight, ActivityIndicator, Text as NativeText } from 'react-native';
  ...
  return (
    <Component
      ...
      style={StyleSheet.flatten([
        ...
        { backgroundColor: colors[type] || theme.colors.primary},
